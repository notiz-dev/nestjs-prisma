...
This guide covers how to install Prisma and integrate it into your NestJS application. You have two main options for integration: using the `nestjs-prisma` library or [copying](/getting-started/owning-the-code) `PrismaService` into your project.
